...
void test_arrow_bool(void **unused) {
    // Test cases.
    sf_bool oob_neg_value = (sf_bool) -129;
    sf_bool max_neg_value = (sf_bool) -128;
    sf_bool reg_neg_value = (sf_bool) -32;
    sf_bool zero_value    = (sf_bool) 0;
    sf_bool one_value     = (sf_bool) 1;
    sf_bool reg_pos_value = (sf_bool) 32;
    sf_bool max_pos_value = (sf_bool) 127;
    sf_bool oob_pos_value = (sf_bool) 128;
    ...
    TEST_CASE_TO_STRING test_cases[] = {
        ...
        { .c1_in = 10, .c2_in = &oob_pos_value,    .c2_out = "1",  .c2_is_null = SF_BOOLEAN_FALSE }
    };
