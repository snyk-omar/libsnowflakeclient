...
void test_arrow_timestamp_ntz_helper(sf_bool use_zero_precision) {
    ...
    TEST_CASE_TO_STRING p0_test_cases[] = {
        ...
        { .c1 = 34, .c2 = f3_min,           .c2_len = 0,  .c2_out = f3_min,         .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 },
        { .c1 = 35, .c2 = f3_max,           .c2_len = 0,  .c2_out = f3_max,         .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 },
        { .c1 = 36, .c2 = f3_reg_neg_hh,    .c2_len = 0,  .c2_out = f3_reg_neg_hh,  .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 },
        { .c1 = 37, .c2 = f3_reg_neg_mm,    .c2_len = 0,  .c2_out = f3_reg_neg_mm,  .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 },
        { .c1 = 38, .c2 = f3_reg_pos_hh,    .c2_len = 0,  .c2_out = f3_reg_pos_hh,  .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 },
        { .c1 = 39, .c2 = f3_reg_pos_mm,    .c2_len = 0,  .c2_out = f3_reg_pos_mm,  .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 }
    };
    ...
    TEST_CASE_TO_STRING p9_test_cases[] = {
        ...
        { .c1 = 15, .c2 = f2_epoch_eve,     .c2_len = 29, .c2_out = f2_epoch_eve,   .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 16, .c2 = f2_epoch,         .c2_len = 29, .c2_out = f2_epoch,       .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 17, .c2 = f2_epochalypse,   .c2_len = 29, .c2_out = f2_epochalypse, .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 18, .c2 = f2_min,           .c2_len = 29, .c2_out = f2_min,         .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 19, .c2 = f2_max,           .c2_len = 29, .c2_out = f2_max,         .c2_is_null = SF_BOOLEAN_FALSE },
        { .c1 = 20, .c2 = f2_noon,          .c2_len = 29, .c2_out = f2_noon,        .c2_is_null = SF_BOOLEAN_FALSE },
        ...
        { .c1 = 34, .c2 = f4_min,           .c2_len = 0,  .c2_out = f4_min,         .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 },
        { .c1 = 35, .c2 = f4_max,           .c2_len = 0,  .c2_out = f4_max,         .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 },
        { .c1 = 36, .c2 = f4_reg_neg_hh,    .c2_len = 0,  .c2_out = f4_reg_neg_hh,  .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 },
        { .c1 = 37, .c2 = f4_reg_neg_mm,    .c2_len = 0,  .c2_out = f4_reg_neg_mm,  .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 },
        { .c1 = 38, .c2 = f4_reg_neg_hh,    .c2_len = 0,  .c2_out = f4_reg_pos_hh,  .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 },
        { .c1 = 39, .c2 = f4_reg_neg_mm,    .c2_len = 0,  .c2_out = f4_reg_pos_mm,  .c2_is_null = SF_BOOLEAN_FALSE, .error_code = 100108 }
    };
